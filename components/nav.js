  ...
  <div className="container bg-white mb-3 shadow-sm">
    <nav className=" navbar navbar-expand-lg">
      ...
      <div className="row col-5 col-lg-3 text-right align-items-center">
        <a className="logo-rs col-4" href="https://www.facebook.com/espacocuidardesi/" target="_blank"><i className="fab fa-facebook-square"></i></a>
        ...
        <a className="logo-rs col-4" href="https://api.whatsapp.com/send?1=pt_BR&phone=5532991757257" target="_blank"><i className="fab fa-whatsapp-square"></i></a>
      </div>
