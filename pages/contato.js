  ...
  return (
    <div className="bg-white">
      ...
      <main className="container">
        ...
        <div className="container row d-flex justify-content-center text-center mx-auto">
          <section className="col-12 col-md-6 my-3 px-4 pt-2 img-thumbnail bg-light ">
            ...
            <div className="py-2">
              ...
              <p className="text-center"><a href="https://api.whatsapp.com/send?1=pt_BR&phone=5532991757257" className="text-dark"><i class="fab fa-whatsapp-square"></i> Whatsapp</a></p>
            </div>
          </section>
        </div>
      </main>
